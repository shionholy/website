...
<html lang="en">
    <head>
        ...
        <title>Tin Nhanh | Chỉnh sửa thông tin</title>
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b>Chỉnh sửa thông tin nhà báo</b></h4>
                                    <hr />
...
?>
            ...
            <input type="text" class="form-control" value="<?php echo htmlentities($row['AdminEmailId']);?>" name="emailid" required>
             ...
             <div class="form-group">
            <label class="col-md-2 control-label">Thời gian tạo</label>
            <div class="col-md-10">
            <input type="text" class="form-control" value="<?php echo htmlentities($row['CreationDate']);?>" name="cdate" readonly>
             ...
             <div class="form-group">
            <label class="col-md-2 control-label">Chỉnh sửa lần cuối</label>
            <div class="col-md-10">
