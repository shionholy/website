...
<html lang="en">
    <head>
        ...
        <title>Tin Nhanh | Thêm nhà báo</title>
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Thêm nhà báo</h4>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b>Thêm nhà báo</b></h4>
                                    <hr />
...
<form class="form-horizontal" name="addsuadmin" method="post">
       ...
       <label for="exampleInputusername">Username (dùng để đăng nhập)</label>
