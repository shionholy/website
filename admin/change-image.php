...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>Tin Nhanh | Cập nhật ảnh thumbnail</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Cập nhật ảnh thumbnail</h4>
...
<div class="col-sm-12">
 <div class="card-box">
<h4 class="m-b-30 m-t-0 header-title"><b>Ảnh thumbnail hiện tại</b></h4>
...
<div class="col-sm-12">
 <div class="card-box">
<h4 class="m-b-30 m-t-0 header-title"><b>Ảnh thumbnail mới</b></h4>
