...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>Tin Nhanh | Quản lý bài đăng</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Bài đăng đã xoá</h4>
...
<td colspan="4" align="center"><h3 style="color:red">Không tìm thấy dữ liệu</h3></td>
<tr>
<?php 
} else {
