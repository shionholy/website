...
<html lang="en">
    <head>
        ...
        <title>Tin Nhanh | Quản lý chuyên mục phụ</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Quản lý chuyên mục phụ</h4>
                                    <ol class="breadcrumb p-0 m-0">
                                        <li>
                                            <a href="#">Admin</a>
                                        </li>
                                        <li>
                                            <a href="#">Chuyên mục phụ</a>
                                        </li>
                                        <li class="active">
                                           Quản lý chuyên mục phụ
                                        </li>
                                    </ol>
...
<td colspan="7" align="center"><h3 style="color:red">Không tìm thấy dữ liệu</h3></td>
<tr>
<?php 
} else {
...
<div class="m-b-30">
 ...
 <h4><i class="fa fa-trash-o" ></i> Chuyên mục phụ đã xoá</h4>
