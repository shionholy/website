...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>Tin Nhanh | Thêm bài đăng</title>
...
<input type="text" class="form-control" id="posttitle" name="posttitle" placeholder="Thêm tiêu đề" required>
</div>
...
<div class="col-sm-12">
 <div class="card-box">
<h4 class="m-b-30 m-t-0 header-title"><b>Ảnh thumbnail</b></h4>
...
<button type="submit" name="submit" class="btn btn-success waves-effect waves-light">Lưu & đăng</button>
