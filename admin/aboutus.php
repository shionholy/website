...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>Tin Nhanh | About us Page</title>
...
<div class="col-sm-12">
 <div class="card-box">
<h4 class="m-b-30 m-t-0 header-title"><b>Thông tin</b></h4>
...
<button type="submit" name="update" class="btn btn-success waves-effect waves-light">Cập nhật & đăng</button>
